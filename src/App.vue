...
// REGISTER USER PAGE - page where user has to register
...
// PAGE FOR POST EDITING - page which opens when i click edit button on post i own (could only be seen if im logged in)
// PAGE FOR CREATING NEW POSTS - page where user (who has secret key) can create new post and upload it
...
// code shoulde be pushed to github
